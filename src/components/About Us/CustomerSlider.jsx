                ...
                <div className="swiper-wrapper">
                  <SwiperSlide className="swiper-slide">
                    <div className="feedback-card">
                      ...
                      <p>
                        AFAQ-Global to the actively encourage customers to leave
                        reviews to the help promote their products and
                        services.”
                      </p>
                  ...
                  <SwiperSlide className="swiper-slide">
                    <div className="feedback-card">
                      ...
                      <p>
                        AFAQ-Agency customer feedback is an invaluable source of
                  ...
                  <SwiperSlide className="swiper-slide">
                    <div className="feedback-card">
                      ...
                      <p>
                        AFAQ-Agency to the actively encourage customers to leave
                        reviews to the help promote their products and
                        services.”
                      </p>
                      <div className="author-name">
